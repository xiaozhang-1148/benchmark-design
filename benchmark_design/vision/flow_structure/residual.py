...
from benchmark_design.vision.flow_structure.geometry import y_range_overlap
from benchmark_design.vision.flow_structure.metrics import (
    _pair_is_inserted,
    sort_blocks_by_y,
    vertical_sequential_score,
)
from benchmark_design.vision.flow_structure.models import FlowStructureMetrics, SkeletonAssessment, TxtBlockGeometry
from benchmark_design.vision.flow_structure.skeleton import assess_skeleton
...
def recover_skeleton_after_residual_removal(
    ...
    *,
    ...
    from benchmark_design.vision.flow_structure.metrics import compute_flow_metrics
