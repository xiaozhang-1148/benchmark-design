...
from benchmark_design.block_level.flow_structure.geometry import bbox_y_overlap_norm, core_x_gap_norm
...
def _bands_have_local_reading_order(
    ...
    *,
    ...
    from benchmark_design.block_level.flow_structure.metrics import vertical_sequential_score
...
def _layout_exists(
    ...
    *,
    ...
    from benchmark_design.block_level.flow_structure.single_flow import forms_vertical_reading_stack
