...
from benchmark_design.block_level.flow_structure.block_roles import block_role, is_flow_context_block
from benchmark_design.block_level.flow_structure.geometry import polygon_area
