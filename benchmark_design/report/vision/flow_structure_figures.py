...
from benchmark_design.vision.flow_structure.flow_group import FLOW_GROUP_HIERARCHY, flow_group_figure_parts
...
def export_flow_structure_figures(
    ...
    *,
    ...
    for flow_structure, groups in FLOW_GROUP_HIERARCHY:
